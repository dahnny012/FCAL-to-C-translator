...
public:
    ...
    /*! This tests various Stmts like print, and interger declarations.
     * It is semantically,syntactically, and lexically correct.
     */
    void test_sample_4 ( void ) { unparse_tests ( "sample_4.dsl" ); }
    
    /*! This tests various Stmts like print,for, and interger declarations.
     * It is semantically,syntactically, and lexically correct.
     */
    void test_sample_5 ( void ) { unparse_tests ( "sample_5.dsl" ); }
    
    
    /*! This tests the new requirements introduced in iter2
     * It is semantically,syntactically, and lexically correct.
     */
    void test_mysample ( void ) { unparse_tests ( "mysample.dsl" ); }
    /*! This tests a real DSL file that has valid syntax all keywords and
     * is semantically and lexically correct.
     */
